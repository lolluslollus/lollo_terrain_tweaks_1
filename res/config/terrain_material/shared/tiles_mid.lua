function data()
    return {
        ...
        detailColorTexture = 'terrain/streetstation_perron_base_mid_albedo_bc1a.dds', -- yes
        --detailMetalGlossAoHTexture = 'terrain/hexagon_tiles_metal_gloss_ao_h.dds', -- dxt5
        detailMetalGlossAoHTexture = 'terrain/streetstation_perron_base_mid_metal_gloss_ao_bc3.dds',
        --detailNormalTexture = 'terrain/hexagon_tiles_nrml.dds', -- bc5u
        detailNormalTexture = 'terrain/streetstation_perron_base_mid_normal_bc5_sharpen.dds',
